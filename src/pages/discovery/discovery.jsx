...
export default class Index extends Component{
    ...
    render () {
        return (
            <View className='discovery-wrapper'>
                ...
                <ScrollView scroll-y className='container discovery withtab'>
                    ...
                    <View className='txtcenter' hidden={this.state.currentNavtab===1 ? false : true}>
                        <Text>圆桌</Text>
                    </View>
                    <View className='txtcenter' hidden={this.state.currentNavtab===2 ? false : true}>
                        <Text>热门</Text>
                    </View>
                    <View className='txtcenter' hidden={this.state.currentNavtab===3 ? false : true}>
                        <Text>收藏</Text>
                    </View>
                </ScrollView>
            </View>
